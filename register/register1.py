...
class BoundingBoxApp:
    def __init__(self, root):
        ...
        self.image = None
        self.image_resolution = None  # Resolusi gambar (piksel per satuan)
    ...
    def open_image(self):
        ...
        if file_path:
            ...
            self.image_resolution = self.image.info.get("dpi", (72, 72))  # Ambil resolusi default jika tidak ada info
            self.display_image()
    ...
    def on_release(self, event):
        if self.current_bb_start:
            ...
            # Hitung dan tampilkan luas bounding box dalam satuan centimeter
    ...
    def calculate_area_cm2(self, x1, y1, x2, y2):
        # Hitung luas bounding box dalam satuan centimeter
        pixels_per_cm_x = 1 / (self.image_resolution[0] / 2.54)  # Faktor konversi piksel ke cm (resolusi X)
        pixels_per_cm_y = 1 / (self.image_resolution[1] / 2.54)  # Faktor konversi piksel ke cm (resolusi Y)
