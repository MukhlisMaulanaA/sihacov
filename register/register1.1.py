...
class BoundingBoxApp:
    def __init__(self, root):
        ...
        self.image_resolution = (400, 400)  # Gantilah dengan nilai yang sesuai
    ...
    def on_release(self, event):
        if self.current_bb_start:
            ...
            # Hitung dan tampilkan luas bounding box dalam satuan centimeter persegi
    ...
    def calculate_area_cm2(self, x1, y1, x2, y2):
        # Hitung luas bounding box dalam satuan centimeter persegi
        pixels_per_cm_x = 1 / (self.image_resolution[0] / 10)  # Faktor konversi piksel ke cm (resolusi X)
        pixels_per_cm_y = 1 / (self.image_resolution[1] / 10)  # Faktor konversi piksel ke cm (resolusi Y)
